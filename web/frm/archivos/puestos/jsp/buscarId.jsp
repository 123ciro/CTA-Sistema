...
<%
    ...
    System.out.println(puesto.getId_puesto());
    ...
    System.out.println(puesto.getEstablecimiento().getId_establecimiento());
    obj.put("nombre_establecimiento", puesto.getEstablecimiento().getNombre_establecimiento());
    System.out.println(puesto.getEstablecimiento().getNombre_establecimiento());
