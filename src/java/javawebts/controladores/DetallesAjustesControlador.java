...
//                        totalf = total5 + totale + total10;
                        ...
                        tabla += "<tr>"
                               ...
                               + "<td class='centrado'>" + rs.getString("nombre_marca") + " " +rs.getString("nombre_producto") + " " + "</td>"
...
//                                + "<td>" + df.format(totaliva10) + "</td>"
                                ...
                                + " type='button' class='btn btn-primary btn-sm botonEditarAjuste'><span class='glyphicon glyphicon-remove'>"
                                + "</span></button></td>"
                                + "</tr>";
