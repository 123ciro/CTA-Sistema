...
public class TimbradosControlador {
    ...
    public static boolean agregar(Timbrados timbrado) {
        ...
        if (Conexion.conectar()) {
            String sql = "insert into timbrados(fecha_inicio,fecha_vencimiento,fecha_actual,numero_timbrado,desde_timbrado,hasta_timbrado,id_puesto,id_establecimiento) "
                    + "values('" + timbrado.getFecha_inicio() + "','"
