...
import javawebts.modelos.Menus;
...
public class FormulariosControlador {
    ...
    public static Formularios buscarId(Formularios formulario) {
        if (Conexion.conectar()) {
            String sql = "select * from formularios,menus where formularios.id_menu=menus.id_menu and id_formulario='" + formulario.getId_formulario() + "'";
            try {
